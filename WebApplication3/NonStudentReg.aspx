<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NonStudentReg.aspx.cs" Inherits="WebApplication1.NonStudentReg" MasterPageFile="~/site.Master" %>
...
&nbsp;<table class="style1">
          ...
          <table class="style1">
            <tr>
                <td class="auto-style15">&nbsp;For Paypal&nbsp;       <asp:ImageButton
    ID="PayPalBtn"
    runat="server"
    ImageUrl="https://www.paypalobjects.com/en_GB/i/btn/btn_buynow_LG.gif"
    onclick="PayPalBtn_Click" /></td>
                <td class="auto-style14">&nbsp;Direct Payment        <asp:Button ID="Button1" runat="server" Text="Pay Now" OnClick="Button1_Click1" />
</td>
            </tr>
        </table>
       </asp:Panel>
